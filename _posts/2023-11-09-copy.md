...
Iterated Representation Learning Framework
...
Can we propose some sort of representation learning evaluation framework using iterated representation learning, e.g. rough guidelines on ideal number of iterations required until convergence, and what this says about how good a model is? 
...
Are there any theoretical guarantees we can prove? 
